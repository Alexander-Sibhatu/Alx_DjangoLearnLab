...
urlspatters = [
    ...
    path('post/<int:pk>/delete/', auth_views.PostDeleteView.as_view(), name='post-delete'),
     path('posts/<int:pk>/comments/new/', auth_views.CommentCreateView.as_view(), name='create_comment'),
    path('comments/<int:pk>/update/', auth_views.CommentUpdateView.as_view(), name='edit_comment'),
    path('comments/<int:pk>/delete/', auth_views.CommentDeleteView.as_view(), name='delete_comment'),
]